...
import { CircleCheckIcon, CircleHelpIcon, CircleIcon, User, LogOut } from "lucide-react"
  ...
  return (
    <NavigationMenu viewport={false} className={'w-full'}>
      <NavigationMenuList className="justify-between w-full">
        <NavigationMenuItem className="flex-grow justify-center">
          <NavigationMenuTrigger className={cn({
            '!bg-accent !rounded-sm': match('/pms/*')
          })}>Property Management</NavigationMenuTrigger>
          <NavigationMenuContent>
        ...
        <NavigationMenuItem>
          <NavigationMenuLink asChild className={navigationMenuTriggerStyle()}>
            <Link to="/docs" className={'flex flex-row items-center'}>
              <span>Inbox</span>
              <Badge variant={'destructive'} className={'p-0.5'}>12</Badge>
            </Link>
          </NavigationMenuLink>
        </NavigationMenuItem>
        <NavigationMenuItem>
          <NavigationMenuTrigger>Inquiries</NavigationMenuTrigger>
          <NavigationMenuContent>
        ...
        <NavigationMenuItem>
          <NavigationMenuTrigger>My Website</NavigationMenuTrigger>
          <NavigationMenuContent>

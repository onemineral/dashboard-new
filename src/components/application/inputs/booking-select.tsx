...
import {Booking} from "@sdk/generated";
                    ...
                    {value ? (
                        <div className="flex items-center gap-2 overflow-hidden">
                            <Avatar className="size-6 rounded-md">
                                <AvatarImage src={value.property?.main_image?.thumbnail}
                                             alt={value.main_guest?.full_name as string}/>
                                    ...
                                    >
                                        <div className="flex items-center gap-3 overflow-hidden w-full">
                                            <Avatar className="size-8 shrink-0 rounded-md">
                                                <AvatarImage src={booking.property?.main_image?.thumbnail}
                                                             alt={booking.main_guest?.full_name as string}/>
                                                <AvatarFallback className="text-xs">
